      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          ...
          >
            ...
            <div className="user-logout-card__info grid flex-1 text-left text-sm leading-tight">
              <span className="user-logout-card__name truncate font-semibold">
                {userName}
              </span>
              <span className="user-logout-card__email truncate text-xs">
                {userEmail}
              </span>
            </div>
        ...
        >
          ...
          <DropdownMenuItem 
            ...
            className="user-logout-card__settings-item"
          >
          ...
          <DropdownMenuItem 
            ...
            className="user-logout-card__logout-item"
          >
